...
/*   Updated: 2025/02/28 13:00:26 by fmontini         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void load_player_sprites(t_matrix *data)
{
    ...
    data->an_enemy.enemy_frames[0] = mlx_xpm_file_to_image(data->mlx, "assets_bonus/dogl.xpm", &data->textures.size, &data->textures.size);
	data->an_enemy.enemy_frames[1] = mlx_xpm_file_to_image(data->mlx, "assets_bonus/dogr.xpm", &data->textures.size, &data->textures.size);
    data->an_enemy.enemy_frames[2] = mlx_xpm_file_to_image(data->mlx, "assets_bonus/dogl.xpm", &data->textures.size, &data->textures.size);
	data->an_enemy.enemy_frames[3] = mlx_xpm_file_to_image(data->mlx, "assets_bonus/dogr.xpm", &data->textures.size, &data->textures.size);
