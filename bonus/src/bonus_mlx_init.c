...
/*   Updated: 2025/03/01 14:59:06 by fmontini         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
// 17 è il valore corrispondente all'evento 
//DestroyNotify, che viene inviato quando 
...
void	open_window(t_matrix *data)
{
	...
	data->win = mlx_new_window(data->mlx, TILE_SIZE * data->cols,
			TILE_SIZE * data->rows, "So Long");
	if (!data->win)
	{
